...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def userRole = new Role(authority: "ROLE_CLIENT").save()
        def moderateurUserInstance = new User(username: "moderateur",password: "admin").save()
        def moderateurRole = new Role(authority: "ROLE_MODERATEUR").save()
        UserRole.create(adminUserInstance, adminRole, true)
        UserRole.create(moderateurUserInstance, moderateurRole, true)
